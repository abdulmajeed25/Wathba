...
const sharedFaqs: RichFaq[] = [
  ...
  { q: 'هل يمكن إلغاء الدعم؟', a: 'نعم — مجاناً من صفحة «تعهّداتي» في حسابك، وحتى ٤٨ ساعة قبل موعد إغلاق الحملة. في الساعات الـ٤٨ الأخيرة تُقفل التعهدات فلا إلغاء ولا تخفيض (الزيادة أو تعهد جديد يبقيان متاحين)، وبعد نجاح الحملة لا يمكن الإلغاء.' },
