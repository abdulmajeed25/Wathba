    ...
    <WathbaShell>
      ...
      >
        ...
        <LegalSection
          n="د1"
          title="مدة الحملة"
          body="المدة الافتراضية والحد الأقصى الذاتي 60 يوماً. المدد بين 61 و120 يوماً تتطلب موافقة إدارية صريحة أثناء المراجعة. لا تتوفر مدد أطول من 120 يوماً حالياً."
        />
        <LegalSection
          n="د2"
          title="قواعد الخصم والتحصيل"
          body="لا يُخصم من داعميك أي مبلغ قبل الموعد النهائي مهما بلغت نسبة التمويل. عند الإغلاق ببلوغ 80٪ تُسحب المبالغ؛ ما تعذّر سحبه يدخل مهلة 72 ساعة ثم يُخصم من المُحصَّل الفعلي إن لم يكتمل. دفعات مراحلك تُحسب من المُحصَّل الفعلي — سترى الرقمين منفصلين في لوحتك، وتصلك إشعارات بأي إلغاء أو تعذّر سحب (أرقام فقط — لا صلاحيات مالية للمبدع)."
        />
      </WathbaLegalPage>
    </WathbaShell>
  );
