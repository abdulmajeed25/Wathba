    ...
    <WathbaShell>
      ...
      >
        ...
        <LegalSection
          n="د١"
          title="مدة الحملة"
          body="المدة الافتراضية والحد الأقصى الذاتي ٦٠ يوماً. المدد بين ٦١ و١٢٠ يوماً تتطلب موافقة إدارية صريحة أثناء المراجعة. لا تتوفر مدد أطول من ١٢٠ يوماً حالياً."
        />
        <LegalSection
          n="د٢"
          title="قواعد الخصم والتحصيل"
          body="لا يُخصم من داعميك أي مبلغ قبل الموعد النهائي مهما بلغت نسبة التمويل. عند الإغلاق ببلوغ ٨٠٪ تُسحب المبالغ؛ ما تعذّر سحبه يدخل مهلة ٧٢ ساعة ثم يُخصم من المُحصَّل الفعلي إن لم يكتمل. دفعات مراحلك تُحسب من المُحصَّل الفعلي — سترى الرقمين منفصلين في لوحتك، وتصلك إشعارات بأي إلغاء أو تعذّر سحب (أرقام فقط — لا صلاحيات مالية للمبدع)."
        />
      </WathbaLegalPage>
    </WathbaShell>
  );
