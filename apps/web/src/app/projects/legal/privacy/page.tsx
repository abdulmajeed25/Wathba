  ...
  return (
    <WathbaShell>
      <WathbaLegalPage
        ...
        intro="تلتزم وثبة بنظام حماية البيانات الشخصية السعودي (PDPL) ولوائح سدايا. هذه السياسة توضّح أي بيانات نجمع، لماذا، وكيف تتحكّم بها. آخر تحديث: 2026/08/04."
      >
        <LegalSection
          n="1"
        ...
        <LegalSection
          n="٭"
          title="قياسات الاستخدام (تحليلات تحترم الخصوصية)"
          body="نسجّل أحداث استخدام محدودة ومُعرّفة مسبقاً (زيارات الصفحات، إنشاء الحساب، التوثيق، الدعم، تقديم المشاريع) لتحسين المنصة. لا نجمع عنوان IP ولا بصمة المتصفح إطلاقاً؛ الزائر غير المسجَّل يحمل مُعرّفاً عشوائياً بحتاً لا يرتبط بأي بيانات شخصية، وأحداث الحساب مشمولة بموافقتك عند التسجيل."
        />
        <LegalSection
          n="3"
        ...
        <LegalSection
          n="4"
          title="فترة الاحتفاظ"
          body="نحتفظ ببياناتك طوال فترة نشاط حسابك + 7 سنوات بعد آخر معاملة (للالتزام بمتطلبات الفواتير والمحاسبة السعودية)، ثم تُحذف نهائياً."
        />
        <LegalSection
          n="5"
          title="حقوقك (PDPL)"
