    ...
    <WathbaShell>
      ...
      >
        ...
        <LegalSection
          ...
          body={
            <>
              ...
              <br />• بطاقة (مدى/فيزا/ماستركارد): ٢٫٩٪ + ١ ر.س للعملية.
              <br />• تابي (٤ دفعات): ٦٫٥٪ + ١٫٥ ر.س للعملية.
              <br />• تمارا (٤ دفعات): ٧٪ + ١٫٥ ر.س للعملية.
              <br />
        ...
        <LegalSection
          ...
          body="عتبة الـ٨٠٪ تُقيَّم على التعهدات لحظة الموعد النهائي. المبلغ المُحصَّل فعلياً قد يقل قليلاً بعدها إذا تعذّر السحب من بعض البطاقات خلال مهلة الـ٧٢ ساعة — لذلك تعرض لوحة الشفافية الرقمين منفصلين دائماً، وتُحسب دفعات المراحل من المُحصَّل فعلياً فقط."
        />
        <LegalSection
          n="3"
