    ...
    <WathbaShell>
      ...
      >
        ...
        <LegalSection
          ...
          body="عند الدعم يُحجز المبلغ فقط دون خصم. التقييم يحدث مرة واحدة عند الموعد النهائي للحملة: إن كانت التعهدات حينها 80٪ فأكثر من الهدف يُخصم المبلغ، وإلا يُحرَّر الحجز تلقائياً. تجاوز الحملة نسبة 80٪ أثناء سيرها لا يُفعّل أي خصم — العبرة بلحظة الإغلاق فقط. ملاحظة: النسبة تُحسب على التعهدات عند الإغلاق؛ قد يقل المبلغ المُحصَّل فعلياً قليلاً بعدها إذا تعذّر السحب من بعض البطاقات."
        />
        <LegalSection
          n="Q2"
        ...
        <LegalSection
          ...
          body={
            <>
              عمولة وثبة <strong>5٪</strong> من إجمالي التمويل، ولا تُحتسب إلا على الحملات
              الناجحة — الحملة التي لا تبلغ عتبتها لا تُكلّف شيئاً. تُضاف ضريبة القيمة
              المضافة <strong>15٪</strong> على العمولة نفسها (لا على كامل المبلغ).
              <br />
        ...
        <LegalSection
          ...
          body="نعم — الإلغاء متاح مجاناً طوال فترة الحملة وحتى 48 ساعة قبل موعد الإغلاق. في الساعات الـ48 الأخيرة تُقفل التعهدات فلا إلغاء ولا تخفيض (الزيادة أو تعهد جديد يبقيان متاحين). عند الإلغاء يُفكّ حجز المبلغ فوراً."
        />
        <LegalSection
          n="Q5ب"
          title="ماذا لو تعذّر السحب من بطاقتي عند نجاح الحملة؟"
          body="نجاح الحملة يتقرر بمبلغ التعهدات لحظة الإغلاق ولا يتأثر بنتائج السحب. إن تعذّر السحب (بطاقة منتهية أو رصيد غير كافٍ) تحصل على مهلة 72 ساعة لتحديث بطاقتك عبر رابط آمن، مع محاولات تلقائية بعد 6 و24 و48 ساعة. بعد انقضاء المهلة يُلغى التعهد وتعود المكافأة للمخزون — دون أي خصم منك."
        />
        <LegalSection
          n="Q5ج"
          title="كيف يعمل الدفع بالتقسيط (تابي / تمارا)؟"
          body="اختر «قسّطها» عند التعهد فيُسجَّل تعهدك ويُحتسب في عدّاد الحملة فوراً — لكن لا يُنشأ أي عقد تقسيط ولا يُخصم شيء إلا إذا نجحت الحملة عند موعد إغلاقها. عندها تُكمل خطوات التقسيط عبر المزوّد خلال 72 ساعة. إن لم تنجح الحملة يُلغى الطلب تلقائياً دون أي أثر."
        />
        <LegalSection
          n="Q6"
        ...
        <LegalSection
          ...
          body={
            <>
              ...
              على الـ5٪ وضريبتها — وليست فاتورة بقيمة دعمك كاملاً، لأن المبلغ الأساسي يذهب
        ...
        <LegalSection
          ...
          body={
            <>
              ...
              للخصوصية والـPDPL: privacy@wathba.sa · ساعات الدعم: الأحد–الخميس 9ص–5م
              بتوقيت الرياض.
            </>
          }
        />
