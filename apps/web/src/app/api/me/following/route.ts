...
/**
 * Batch ACCOUNT / U5 — BFF for /following.
 *
 * `type` selects which of the THREE relations is read. They are three separate
 ...
 * response would rebuild the very conflation this batch exists to undo.
 */
