import {
  IsDateString, IsInt, IsOptional, IsString, IsUUID, MaxLength, Min, MinLength,
...
export class CreateRFQDto {
  ...
  @ApiProperty({ example: 'مطلوب تصنيع ٢,٥٠٠ وحدة من إطار درون من ألياف الكربون بمواصفات…' })
  @IsString() @MinLength(40) @MaxLength(4_000)
  specsAr!: string;
...
export class SubmitBidDto {
  @ApiProperty({ example: 19_250_000 })
  @IsInt() @Min(100) amountHalalas!: number;

  @ApiProperty({ example: 45 })
  @IsInt() @Min(1) leadTimeDays!: number;
